...
function get_html_docs($obj) {
    ...
    if (file_exists($filename)) {
        ...
        $markdown .= "<div class=\"alert alert-warning\">No information for this object</div>";
    }

    if ($obj) {
        $markdown .= "\n\n";
        $markdown .= get_depends_markdown('Nominated by',     $obj['depends']);
        $markdown .= get_depends_markdown('Nominated', $obj['dependedOnBy']);
    }
